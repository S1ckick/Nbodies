...
//k2 - acceleration 0.5 timesteps in the future based on k1 acceleration value
    velocity_update = util.partial_step(target_body.v, k1, 0.5, t);
    location_update = util.partial_step(target_body.r, velocity_update, 0.5, t);
    k2 = (external_body.r - location_update) * f;

//k3 acceleration 0.5 timesteps in the future using k2 acceleration
    velocity_update = util.partial_step(target_body.v, k2, 0.5, t);
    location_update = util.partial_step(target_body.r, velocity_update, 0.5, t);
    k3 = (external_body.r - location_update) * f;

//k4 - location 1 timestep in the future using k3 acceleration
    velocity_update = util.partial_step(target_body.v, k3, 1, t);
    location_update = util.partial_step(target_body.r, velocity_update, 1, t);

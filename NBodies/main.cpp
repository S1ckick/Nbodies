...
int main() {
  ...
  bodies.push_back(Body<current_type>({ current_type(0), current_type(1.4e3),
  current_type(0) },{ current_type(3),current_type(0),current_type(0)
  },current_type(6))); bodies.push_back(Body<current_type>({ current_type(0),
  current_type(1.3e3), current_type(0) },{
  current_type(3),current_type(0),current_type(0) },current_type(6)));
  bodies.push_back(Body<current_type>({ current_type(0), current_type(1.2e3),
  current_type(0) },{ current_type(3),current_type(0),current_type(0)
  },current_type(6))); bodies.push_back(Body<current_type>({ current_type(0),
  current_type(1.1e3), current_type(0) },{
  current_type(3),current_type(0),current_type(0) },current_type(6)));
  bodies.push_back(Body<current_type>({ current_type(0), current_type(1.56e3),
  current_type(0) },{ current_type(3),current_type(0),current_type(0)
  },current_type(6))); bodies.push_back(Body<current_type>({ current_type(0),
  current_type(1.5e3), current_type(0) },{
  current_type(3),current_type(0),current_type(0) },current_type(6)));
  bodies.push_back(Body<current_type>({ current_type(0), current_type(1.51e3),
  current_type(0) },{ current_type(3),current_type(0),current_type(0)
  },current_type(6)));
  */
  ...
  /*
  bodies.push_back(Body<current_type>({ current_type("0"),
  current_type("1.3e3"), current_type("0") },{
  current_type("3"),current_type("0"),current_type("0") },current_type("6")));
  bodies.push_back(Body<current_type>({ current_type("0"),
  current_type("1.2e3"), current_type("0") },{
  current_type("3"),current_type("0"),current_type("0") },current_type("6")));
  bodies.push_back(Body<current_type>({ current_type("0"),
  current_type("1.1e3"), current_type("0") },{
  current_type("3"),current_type("0"),current_type("0") },current_type("6")));
  bodies.push_back(Body<current_type>({ current_type("0"),
  current_type("1.56e3"), current_type("0") },{
  current_type("3"),current_type("0"),current_type("0") },current_type("6")));
  bodies.push_back(Body<current_type>({ current_type("0"),
  current_type("1.5e3"), current_type("0") },{
  current_type("3"),current_type("0"),current_type("0") },current_type("6")));
  bodies.push_back(Body<current_type>({ current_type("0"),
  current_type("1.51e3"), current_type("0") },{
  current_type("3"),current_type("0"),current_type("0") },current_type("6")));
  */
...
#ifdef NUMBER_DOUBLE
      data_energy["energy"].push_back(
          abs((energy - init_energy) / init_energy).str(32));
#endif
...
#ifdef NUMBER_DOUBLE
      data_center["center"].push_back(
          abs((init_center_mass - center_mass).Len()).str(32));
#endif
    }
  }
